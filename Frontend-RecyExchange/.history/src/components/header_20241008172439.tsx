...
const header = () => {
  return (
    <div>
  <header className="fixed inset-x-0 top-0 z-50 bg-gradient-to-r from-[#76C7FF] via-[#FFFFFF] to-[#76C7FF]">
        <nav
        ...
        >
          ...
          <div className="flex flex-row w-screen justify-between">
            ...
            <div className="hidden lg:flex lg:gap-x-12 lg:items-center">
              ...
              <a
                    href="#"
                    className=" color-primary w-56 h-11 text-white font-bold text-base flex items-center justify-center rounded-full 
